...
const TermsAndConditions = () => {
    return (
        <div>
            ...
            The amount invested will be subject to non-retrieval for a duration of 3 months from the date of investment, except under circumstances described in the Account Termination section below. After this 3-month period, you may retrieve your investment value as per your requirement. The current value of your investment will be determined based on the performance of the investments made on your behalf.<br /><br />
