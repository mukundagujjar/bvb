...
const PrivacyPolicy = () => {
    return (
        <div>
            ...
            We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.<br /><br />
            ...
            <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors">Collecting and Using Your Personal Data</h2><br />
            <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Types of Data Collected</h3><br />

            <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Personal Data</h4><br />
            ...
            <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Usage Data</h4><br />
            ...
            <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Tracking Technologies and Cookies</h4><br />
            ...
            <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Use of Your Personal Data</h3><br />

            The Agency may use Personal Data for the following purposes:<br />
            ...
            <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Retention of Your Personal Data</h3><br />
            ...
            <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Disclosure of Your Personal Data</h3><br />

            <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
                Business Transactions</h4><br />
            If the Agency is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.<br /><br />

            <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Law enforcement</h4>
            Under certain circumstances, the Agency may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).<br /><br />

            <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Other legal requirements</h4><br />
            The Agency may disclose Your Personal Data in the good faith belief that such action is necessary to:<br />
            <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            ...
            <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Security of Your Personal Data</h3><br />
            ...
            Bulls v/s Bears is not SEBI certified and is not affiliated with any other organization. This should be understood by all clients before engaging our services.<br /><br />
